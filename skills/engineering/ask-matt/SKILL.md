...
**`/setup-matt-pocock-skills`**: optional at FIKS. Without it, the skills assume the FIKS default (local markdown issues, standard triage labels, single-context domain docs). Run it only when a repo needs to override that.
